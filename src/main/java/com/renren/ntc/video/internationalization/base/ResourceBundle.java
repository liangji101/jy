...
public abstract class ResourceBundle {
     ...
     *
     * <li>The {@link ResourceBundle.Control#newBundle(String, java.util.Locale,
     ...
     * calls the {@link ResourceBundle.Control#needsReload(String, java.util.Locale,
     ...
     *
     * @since 1.6
     * @see ResourceBundle.Control#getTimeToLive(String, java.util.Locale)
     */
     ...
     * ResourceBundle.Control#getCandidateLocales(String, java.util.Locale)
