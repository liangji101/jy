 ...
 * {@link #store(java.io.Writer, String) store(Writer, String)}
 * methods load and store properties from and to a character based stream
 * in a simple line-oriented format specified below.
 *
 * The {@link #load(java.io.InputStream) load(InputStream)} <tt>/</tt>
 * {@link #store(java.io.OutputStream, String) store(OutputStream, String)}
 ...
 * #storeToXML(java.io.OutputStream, String, String)} methods load and store properties
