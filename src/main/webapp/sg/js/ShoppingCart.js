(function (window, document) {
    ...
    shoppingCart.findCateIdForProductId = function (productID) {
        ...
        for (var cates in this.shoppingItemsCategraysDict) {
            ...
            for (var item in items) {
                var itemdetail = items[item];
                if (itemdetail.id == productID)return cates;
            }
        }
    };
...
//            }
        ...
        if (action == 'add') {
            ...
            if (this.shoppingItemsCategraysDict[cateId][id]) {
                ...
                this.shoppingItemsCategraysDict[cateId][id] = {'name': fields.name, 'price': fields.price, 'quantity': fields.quantity};
            }
    ...
    shoppingCart.getItemString = function () {
        ...
        for (var cates in this.shoppingItemsCategraysDict) {
            ...
            for (var item in items) {
                ...
                results.push({'item_id': itemdetail.id, "count": itemdetail.quantity,
    ...
    shoppingCart.countChangeAddHanlder = function (ele) {
        ...
        var cateId = 0;
        if (categray) {
            cateId = categray.data('categray-id');
        } else {
